  ...
  var muiPicker={
    init:function (e, t, i, a) {
        var n = 30, r = 90, s = 40, c = 10, l = e.rad2deg = function (e) {
                ...
                return e * (Math.PI / 180)
            }, navigator.platform.toLowerCase()), d = navigator.userAgent.toLowerCase(),
        ...
        p.prototype.findElementItems = function () {
            ...
            e.holder.addEventListener("touchstart", function (a) {
                ...
                a.preventDefault();
                var n = (a.changedTouches ? a.changedTouches[0] : a).pageY, r = n - i, s = e.calcAngle(r),
                    c = r > 0 ? t - s : t + s;
            ...
            if (t) i.lastMoveStart = a.pageY, i.lastMoveTime = e.timeStamp || Date.now(), i.startAngle = i.list.angle; else {
            ...
            var t = this, i = e.changedTouches ? e.changedTouches[0] : e, a = e.timeStamp || Date.now(),
                n = (i.pageY - t.lastMoveStart) / (a - t.lastMoveTime), r = n > 0 ? -1 : 1, s = 6e-4 * r * -1,
                c = Math.abs(n / s), l = n * c / 2, o = t.list.angle, d = t.calcAngle(l) * r, u = d;
            ...
            setTimeout(function () {
                ...
                e.trigger && (a != i.lastIndex || t) && e.trigger(i.holder, "change", {index: a, item: n}), i.lastIndex = a
            }, 0)
     ...
     dtPickerfun:function (e, t) {
        ...
        e.DtPicker = mui.extend({
            init: function (a) {
                ...
                if (i.customData.y) n = i.customData.y; else for (var r = i.beginYear, s = i.endYear, c = r; s >= c; c++) n.push({
                    text: c + "",
                    value: c
                });
                ...
                var t = this, i = t.options, a = t.ui, n = [];
                if (i.customData.m) n = i.customData.m; else for (var r = 1; 12 >= r; r++) {
                    var s = t._fill(r);
                    n.push({text: s, value: s})
                }
                a.m.picker.setItems(n)
            }, _createDay: function (e) {
                var t = this, i = t.options, a = t.ui, n = [];
                if (i.customData.d) n = i.customData.d; else for (var r = t.getDayNum(parseInt(a.y.picker.getSelectedValue()), parseInt(a.m.picker.getSelectedValue())), s = 1; r >= s; s++) {
                    var c = t._fill(s);
                    n.push({text: c, value: c})
                }
                a.d.picker.setItems(n), e = e || a.d.picker.getSelectedValue()
            }, _createHours: function (e) {
                var t = this, i = t.options, a = t.ui, n = [];
                if (i.customData.h) n = i.customData.h; else for (var r = 0; 23 >= r; r++) {
                    var s = t._fill(r);
                    n.push({text: s, value: s})
                }
                ...
                var t = this, i = t.options, a = t.ui, n = [];
                if (i.customData.i) n = i.customData.i; else for (var r = 0; 59 >= r; r++) {
                    var s = t._fill(r);
                    n.push({text: s, value: s})
                }
