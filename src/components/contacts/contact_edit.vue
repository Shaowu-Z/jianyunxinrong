    ...
    <div id="app">
        ...
        <section class="mui-content">
			<ul class="mui-table-view eg-table-view eg-detail-list">
				...
				<li class="mui-table-view-cell" @click="department">
					<a class="mui-navigate-right text" >部门<span class="mui-badge mui-badge-inverted" id="deptName_id" v-text="none.deptName" @click="department"></span></a>
				</li>
			</ul>
        ...
        <div class="pop-up" style="height: 100%;" id="select_dept" v-if="select_dept">
            ...
            <div class="pop-header">
                ...
                <button class="mui-btn mui-btn-link mui-pull-left" onclick="javascript:$('#select_dept').hide();appApi.showBack();">取消</button>
            </div>
    ...
    methods:{
            ...
            if(this.none.memberType=="1"){
                ...
                layer.open({
                    ...
                    ,yes: function(index, layero){
                        var memberId = window.location.href.split("?")[1].split("=")[1];
                        this.$http.post("/api/concats_api/delete_member_batch",{memberIds:memberId}).then(function (response) {
        ...
        show_depts () {//选择部门
            ...
            function getSubDept(teamId,parentDeptId) {//查询下级部门列表(部门ID为空或者0时，查询团队ID下的一级部门列表)
                ...
                console.info(par);
                this.$router.post(getUrl()+"/concats_api/query_dept_list",par).then(function (response) {
