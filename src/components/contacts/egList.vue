...
<section class="mui-content" id="eg_list">
	<div id='list' class="mui-indexed-list address-list hide">
		<div class="singlebox mui-singlebox">
			<a href="javascript:appApi.openNewWindow(pagepath+'/contacts/new_friends.html')" class="mui-navigate-right">新的好友</a>
		</div>
		...
		<div class="mui-indexed-list-bar">
			<div class="align-middle">
				<!--<a :class="{'mui-hidden':item.first!='A'}">A</a>-->
				<!--<a :class="{'mui-hidden':item.first!='B'}">B</a>-->
				<!--<a :class="{'mui-hidden':item.first!='C'}">C</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">D</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">E</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">F</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">G</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">H</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">I</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">J</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">K</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">L</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">M</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">N</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">O</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">P</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">Q</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">R</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">S</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">T</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">U</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">V</a>-->
				<!--<a :class="{'mui-hidden': getIndexShow}">W</a>-->
				...
				<!--<a :class="{'mui-hidden':item.first!='D'}">X</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">Y</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">Z</a>-->
				<!--<a :class="{'mui-hidden':item.first!='D'}">#</a>-->
			</div>
		</div>
