                            ...
                            <div id="id_Top" class="gather-item fixed-top">
                                ...
                                <div id="id_mini_top" class="gather-item-header tight" style="display: none;background: #eee;" >
                                    <div v-for="(item,index) in items_top" :key="index">
                                        <span class="mui-pull-right"> 工单条数:<strong v-text="comm.formatNumber(item.tiao,0)"></strong></span>
                                        ...
                                        <a class="" href="javascript:void(0)">
                                            <div class="product-info-box text">
                                                <div class="labor-name">
                                                    ...
                                                    <span class="name mui-ellipsis" v-text="item.dateShenqing"></span>
                                                </div>
                                                <!--<p class="gray-pro-info sec-txt">派工日期：<strong class="mui-pull-right"  v-text="item.shuliang"></strong></p>-->
                                                <p class="gray-pro-info sec-txt">执行单位：<strong class="mui-pull-right"  v-text="item.companySaleName"></strong></p>
                                                <p class="gray-pro-info sec-txt">派工单位：<strong class="mui-pull-right"  v-text="item.companyBuyName"></strong></p>
                                ...
                                <div id="group_list" class="prolist-line project-list cus_data" >
                                    <div v-for="(item,index) in litems_group_list" :key="index" class="list-item" @click="divClick.group_list([[item.companySaleRoomID,item.companySaleName],[item.companyBuyRoomID,item.companyBuyName]])">
                                        <div class="product-info-box">
                                            ...
                                            <p class="gray-pro-info sec-txt">工单条数：<strong class="mui-pull-right" style="font-size: 17px;" v-text="comm.formatNumber(item.tiao,0)"></strong></p>
                                        </div>
                                    </div>
                                </div>
                                <!--group list -end- -->
...
<script>
    ...
    // js链接java的链接配置
    $url.java_path_group = "/chart/column/group_w_paigongdan";
    $url.java_path_table = "/chart/column/table_w_paigongdan";
    /**
     * 主页页面
     */
    // 时间范围筛选
