                                        ...
                                        <a class="" href="javascript:void(0)">
                                            <div class="product-info-box text">
                                                <div class="labor-name">
                                                    ...
                                                    <span class="name mui-ellipsis"  v-text="item.companySaleName"></span>
                                                </div>
...
<script>
    ...
    // js链接java的链接配置
    $url.java_path_group = "/chart/column/group_w_laowubaoliang";
    $url.java_path_table = "/chart/column/table_w_laowubaoliang";
    /**
     * 主页页面
     */
    // 时间范围筛选
    ...
    $label.group=["报量人(工长)"];// 配置分组标题
    $label.group_danwei=["个工长"]; // 分组后记录条数的单位
    $label.no_group_danwei="份"    //无汇总的情况下，记录条数的单位
    //配置排序
    $label.order=["报量日期"]; //排序的标题
    $order.by=["dateShenqing"]; //排序对应字段
