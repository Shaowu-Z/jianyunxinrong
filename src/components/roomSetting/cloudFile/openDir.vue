    ...
    <div id="app">
        <header class="mui-bar mui-bar-nav" id="js-head">
            ...
            <div v-if="headerMode == 0">
                <a class="mui-icon iconfont icon-c-upload mui-pull-right" id="uoload" onclick="app.uploadFile()"></a>
            </div>
            <div v-else>
                <button class="mui-btn mui-btn-link mui-pull-left" onclick="app.allSelect()">全选</button>
                <button class="mui-btn mui-btn-link mui-pull-right" onclick="app.backSelectMode()">取消</button>
            </div>
        ...
        <section class="mui-content" id="dish_content" v-show="loadStatus">
            ...
            <div class="tab-box">
                <div id="dish-tab" class="sift-tab search-sort">
                    <div class="tab-item sort-integrative" onclick="app.$data.sortShow = !app.$data.sortShow">
                                        ...
                                        <a class="" href="javascript:;" @click="openDir(obj.id,obj.type,obj.name,obj.suffix,obj.status,$event)">
                                            <div class="oa-contact-cell mui-table">
                                                <div v-show="selectMode && obj.status==0" class="oa-contact-input mui-table-cell">
                                                    <input type="checkbox" name="selectItem" :data-type="obj.type" :data-id="obj.id" :data-name="obj.name" :data-suffix="obj.suffix" :data-status="obj.status" :data-userId="obj.userId"  v-bind:value="obj.id" onchange="app.selectEvent(this)" />
                                                </div>
            ...
            <div id="editBox" class="floorzr" style="position: fixed;bottom: 0;width: 100%;margin-bottom: 0;display: none;" v-show="showEditBox">
                ...
                <p class="remov" onclick="app.$data.showEditBox = false">取消{{isSys}}</p>
            </div>
            <!--编辑文件夹弹框结束-->
