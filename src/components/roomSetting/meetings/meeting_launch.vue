...
export default {
    ...
    methods:{
        saveMeeting:function () {
            ...
            var userIds = "";
            //进行url转码问题
            var userNames = decodeURIComponent(setting.getCookie("username"))+",";
            ...
            roomdata.append("mCreateUser",setting.getCookie("userid"));//当前用户=创建者（主持人）
            roomdata.append("mCreateUserName",setting.getCookie("username"));//当前用户=创建者名称（主持人）
